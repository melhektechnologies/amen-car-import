...
export const vehicles: Vehicle[] = [
  ...
  },
  {
    ...
    description: "The ultimate adventure companion. Rugged, powerful, and ready for any terrain in Ethiopia.",
  },
  {
    slug: "hyundai-staria",
    brand: "Hyundai",
    ...
    description: "Futuristic luxury transport. The Staria offers unparalleled comfort for group travel and executive transport.",
  },
